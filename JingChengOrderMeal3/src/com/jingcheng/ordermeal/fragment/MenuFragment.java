...
public class MenuFragment extends BaseFragment {
	...
	private void initData() {
		...
		list_dish.add(new Dish(1, "dishName_1", "dishName_1详情", 11, R.drawable.img_1, 0, false, false));
		list_dish.add(new Dish(2, "dishName_2", "dishName_2详情", 22, R.drawable.img_2, 3, true, false));
		list_dish.add(new Dish(3, "dishName_3", "dishName_3详情", 33, R.drawable.img_3, 0, false, false));
		list_dish.add(new Dish(4, "dishName_4", "dishName_4详情", 44, R.drawable.img_4, 0, false, false));
		list_dish.add(new Dish(5, "dishName_5", "dishName_5详情", 55, R.drawable.img_5, 5, false, false));
		list_dish.add(new Dish(6, "dishName_6", "dishName_6详情", 66, R.drawable.img_6, 0, true, false));
		list_dish.add(new Dish(7, "dishName_7", "dishName_7详情", 77, R.drawable.img_7, 0, false, false));
	}
